...
public class ChangePasswordTest {
    ...
    public void changeEmailTest() {
        ...
        ValidatableResponse changePasswordResponse = userClient.getChangeDataWithAuthResponse(token, User.getDifferentPassword());
    ...
    public void clear() {
        userClient.delete(User.getDifferentPassword());
    }
}
